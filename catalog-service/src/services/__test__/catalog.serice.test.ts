...
describe("catalogService", () => {
    ...
    describe("createProduct", () => {
        ...
        test("should throw error with unable to create prodcut", async () => {
            const service = new CatalogService(repository)
            const reqBody = mockProduct({
                price: +faker.commerce.price()
            })
        ...
        test("should throw  error with product already exist", async () => {
            ...
            jest
                .spyOn(repository, "create") // listening create function
                .mockImplementationOnce(() => Promise.reject(new Error("product already exist"))) //result manipulated
    ...
    describe("deleteProduct",()=>{
        test("should dalete product by id",async()=>{
            const service = new CatalogService(repository)
            const product= ProductFactory.build()
